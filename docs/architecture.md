...
[src/nagini.js](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/nagini.js)
exposes
[`createManager`](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/nagini.js#L29),
[`waitForReady`](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/nagini.js#L76)
and
[`executeFromUrl`](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/nagini.js#L111).
...
[src/utils/validation.js](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/utils/validation.js)
centralizes parameter checks (`validateBackend`, `validatePackages`,
[`validateExecutionParams`](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/utils/validation.js#L170), ...)
...
[`checkDangerousPatterns`](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/utils/validation.js#L181)
heuristic, which is never applied automatically.

### PyodideManager

[src/pyodide/manager/manager.js](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/manager/manager.js)
is the main-thread half of the Pyodide backend. It owns the worker, a
[pending-request map keyed by correlation id](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/manager/manager.js#L114-L119),
an
[`executionChain`](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/manager/manager.js#L112)
that serializes executions, a
[`readyPromise`](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/manager/manager.js#L123-L132)
and the
[`executionHistory` capped at 50 entries](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/manager/manager.js#L37).
Every request goes through
[`_postRequest`](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/manager/manager.js#L284)
and every worker message through
[`_dispatchMessage`](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/manager/manager.js#L219).
...
[manager-static-execution.js](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/manager/manager-static-execution.js)
implements the fire-and-forget
[`executeFile`](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/manager/manager-static-execution.js#L40).
[manager-input.js](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/manager/manager-input.js)
holds the input state machine (queue, callback, current prompt) and reacts to
`input_required` messages in
[`handleInputMessage`](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/manager/manager-input.js#L118).
[manager-fs.js](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/manager/manager-fs.js)
wraps the five filesystem operations and unwraps their results in
[`fs`](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/manager/manager-fs.js#L32).

### Blob worker creation

[src/utils/createBlobWorker.js](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/utils/createBlobWorker.js)
fetches `worker-dist.js` as text, wraps it in a `Blob` and returns an object
URL in
[`createBlobWorkerUrl`](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/utils/createBlobWorker.js#L15).
...
[src/pyodide/worker/worker-dist.js](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/worker/worker-dist.js)
...
[constructor](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/manager/manager.js#L62-L64)),
...
[src/pyodide/worker/worker.js](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/worker/worker.js)
holds the worker state (pyodide instance, loaded package sets) and installs
the single
[`self.onmessage`](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/worker/worker.js#L64)
...
[src/pyodide/worker/worker-handlers.js](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/worker/worker-handlers.js)
routes messages by type in
[`handleMessage`](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/worker/worker-handlers.js#L85)
and owns
[`handleInit`](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/worker/worker-handlers.js#L117):
...
[as bundled strings](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/worker/worker-handlers.js#L15-L18)
through the webpack `@python` alias.

### worker-execution.js

[src/pyodide/worker/worker-execution.js](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/worker/worker-execution.js)
is the execute path:
[`handleExecute`](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/worker/worker-execution.js#L18)
...
[`captureOutputs`](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/worker/worker-execution.js#L102)
and posts a single `result` message carrying the request id.

### worker-input.js

[src/pyodide/worker/worker-input.js](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/worker/worker-input.js)
...
[`handleInputResponse`](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/worker/worker-input.js#L96)
...
[src/pyodide/worker/worker-fs.js](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/worker/worker-fs.js)
executes filesystem operations against Pyodide's virtual FS in
[`executeFS`](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/worker/worker-fs.js#L40)
(writeFile, readFile, mkdir, exists, listdir) and also hosts
[`loadPackages`](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/worker/worker-fs.js#L73),
...
[src/pyodide/worker/worker-config.js](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/worker/worker-config.js)
centralizes constants, most importantly the default
[`PYODIDE_CDN`](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/worker/worker-config.js#L17)
...
[src/pyodide/python/](https://github.com/pointcarre-app/nagini/tree/v0.0.51/src/pyodide/python)
...
[capture_system.py](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/python/capture_system.py)
replaces `sys.stdout` and `sys.stderr` with capture buffers in
[`reset_captures`](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/python/capture_system.py#L49)
and implements
[`get_stdout`](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/python/capture_system.py#L76),
[`get_missive`](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/python/capture_system.py#L92) and
[`get_figures`](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/python/capture_system.py#L112),
plus the once-per-execution
[`missive`](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/python/capture_system.py#L146)
function.

[code_transformation.py](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/python/code_transformation.py)
...
AST, through
[`transform_code_for_execution`](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/python/code_transformation.py#L86)
and the
[`_AwaitInputTransformer`](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/python/code_transformation.py#L15)
visitor. Calls inside sync functions, lambdas or class bodies are left alone,
where `await` would be invalid.

[pyodide_utilities.py](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/python/pyodide_utilities.py)
provides
[`setup_matplotlib`](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/python/pyodide_utilities.py#L7):
...
[src/pyodide/file-loader/file-loader.js](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/file-loader/file-loader.js)
...
[`loadFiles`](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/file-loader/file-loader.js#L58).
Although it lives outside the worker directory, it runs inside the worker: it
is imported by
[worker-handlers.js](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/worker/worker-handlers.js#L12)
...
[worker-config.js](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/worker/worker-config.js#L17).
Passing `options.pyodideCdnUrl` to `createManager` makes the worker run
[`import(pyodide.mjs)` and `loadPyodide`](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/worker/worker-handlers.js#L132-L169)
...
[src/brython/manager/manager.js](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/brython/manager/manager.js)
mirrors the PyodideManager surface but runs everything in the main thread.
[loader.js](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/brython/manager/loader.js)
injects
[brython.js and brython_stdlib.js](https://github.com/pointcarre-app/nagini/tree/v0.0.51/src/brython/lib)
as script tags (paths overridable through `brythonJsPath` and
`brythonStdlibPath`), and
[executor.js](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/brython/manager/executor.js)
...
[webpack.config.cjs](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/worker/webpack.config.cjs)
builds `worker-dist.js` from `worker.js`, with the
[`@python` alias](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/worker/webpack.config.cjs#L15)
and an
[asset/source rule](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/worker/webpack.config.cjs#L37-L38)
that turns `.py` files into plain strings.
[webpack.umd.config.cjs](https://github.com/pointcarre-app/nagini/blob/v0.0.51/src/pyodide/worker/webpack.umd.config.cjs)
...
[package.json](https://github.com/pointcarre-app/nagini/blob/v0.0.51/package.json)).
