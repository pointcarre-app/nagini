...
1. `Nagini.createManager("pyodide", packages, micropipPackages, filesToLoad, workerPath, options)`
   ([nagini.js#L29](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/nagini.js#L29))
   checks the backend name with `validateBackend`
   ([validation.js#L208](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/utils/validation.js#L208)),
   requires a `worker-dist.js` path
   ([nagini.js#L35-L46](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/nagini.js#L35-L46)),
   dynamically imports the backend
   ([nagini.js#L48](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/nagini.js#L48))
   and constructs the manager
   ([nagini.js#L54](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/nagini.js#L54)).
2. The `PyodideManager` constructor
   ([manager.js#L52](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/manager/manager.js#L52))
   validates every argument
   ([manager.js#L56-L64](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/manager/manager.js#L56-L64)),
   creates the `readyPromise`
   ([manager.js#L123-L132](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/manager/manager.js#L123-L132))
   and calls `initWorker`
   ([manager.js#L135](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/manager/manager.js#L135)).
3. `initWorker`
   ([manager.js#L165](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/manager/manager.js#L165))
   fetches the bundle and wraps it in a blob URL with `createBlobWorkerUrl`
   ([createBlobWorker.js#L15](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/utils/createBlobWorker.js#L15)),
   creates the `Worker`
   ([manager.js#L173](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/manager/manager.js#L173)),
   installs `_dispatchMessage` as the permanent `onmessage` handler
   ([manager.js#L177](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/manager/manager.js#L177))
   and posts the `init` message
   ([manager.js#L195-L202](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/manager/manager.js#L195-L202)).
4. In the worker, `self.onmessage`
   ([worker.js#L64](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/worker/worker.js#L64))
   routes through `handleMessage`
   ([worker-handlers.js#L85](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/worker/worker-handlers.js#L85))
   to `handleInit`
   ([worker-handlers.js#L117](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/worker/worker-handlers.js#L117)):
   a dynamic `import` of `pyodide.mjs` followed by `loadPyodide`
   ([worker-handlers.js#L132-L169](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/worker/worker-handlers.js#L132-L169))
   pulls the runtime from the CDN pinned in
   ([worker-config.js#L17](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/worker/worker-config.js#L17))
...
7. `filesToLoad` entries are downloaded into the virtual filesystem by
   ...
   ([worker-handlers.js#L216-L224](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/worker/worker-handlers.js#L216-L224),
   [file-loader.js#L58](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/file-loader/file-loader.js#L58)),
   with up to three attempts and a growing delay between them.
8. Packages install through `loadPackages`
   ([worker-handlers.js#L227](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/worker/worker-handlers.js#L227),
   [worker-fs.js#L73](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/worker/worker-fs.js#L73)),
   micropip packages through `micropip.install`
   ([worker-handlers.js#L230-L246](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/worker/worker-handlers.js#L230-L246));
   both skip what this worker already loaded. Then `setup_matplotlib()`
   ([worker-handlers.js#L250](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/worker/worker-handlers.js#L250),
   [pyodide_utilities.py#L7](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/python/pyodide_utilities.py#L7))
...
9. The worker posts `{type: "ready", snapshotRestored, inputMode}`
   ...
   ([manager.js#L236-L238](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/manager/manager.js#L236-L238)).
10. `Nagini.waitForReady`
    ([nagini.js#L76](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/nagini.js#L76))
    races the `readyPromise` against a timeout
    ([nagini.js#L80-L88](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/nagini.js#L80-L88));
    managers without a `readyPromise` fall back to polling `isReady`
    ([nagini.js#L95-L101](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/nagini.js#L95-L101)).
...
([worker-handlers.js#L258-L262](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/worker/worker-handlers.js#L258-L262)).
The manager then rejects the `readyPromise` with the original cause and fails
every pending request
([manager.js#L240-L246](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/manager/manager.js#L240-L246)),
...
1. `manager.executeAsync(filename, code, namespace?, timeoutMs = 30000)`
   ([manager.js#L416](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/manager/manager.js#L416))
   chains the run on `executionChain`
   ([manager.js#L436-L437](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/manager/manager.js#L436-L437)),
   so two calls on the same manager never interleave.
2. When its turn comes, `run()` validates the parameters
   ([manager.js#L422](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/manager/manager.js#L422),
   [validation.js#L170](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/utils/validation.js#L170))
   and throws if the manager is not ready
   ([manager.js#L423-L425](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/manager/manager.js#L423-L425)).
3. `_postRequest`
   ([manager.js#L284](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/manager/manager.js#L284))
   allocates a correlation id
   ([manager.js#L286](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/manager/manager.js#L286)),
   stores `{resolve, reject, timeoutId}` in `_pendingRequests`
   ([manager.js#L293](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/manager/manager.js#L293)),
   arms the timeout
   ([manager.js#L287-L291](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/manager/manager.js#L287-L291))
   and posts `{type: "execute", filename, code, id}`
   ([manager.js#L296](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/manager/manager.js#L296)).
   `namespace` is added to the message only when provided
   ([manager.js#L426-L429](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/manager/manager.js#L426-L429)).
4. In the worker, `handleExecute`
   ([worker-execution.js#L18](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/worker/worker-execution.js#L18))
...
5. `reset_captures()`
   ([worker-execution.js#L29](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/worker/worker-execution.js#L29),
   [capture_system.py#L49](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/python/capture_system.py#L49))
   ...
   ([capture_system.py#L72-L73](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/python/capture_system.py#L72-L73)).
6. The code always runs through `runPythonAsync`
   ([worker-execution.js#L42](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/worker/worker-execution.js#L42)):
   it handles synchronous code identically and enables top-level `await`.
7. `captureOutputs`
   ([worker-execution.js#L110](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/worker/worker-execution.js#L110))
   pulls `get_stdout()` and `get_stderr()`
   ([capture_system.py#L76-L83](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/python/capture_system.py#L76-L83)),
   `get_missive()`
   ([capture_system.py#L92](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/python/capture_system.py#L92)),
   ...
   ([worker-execution.js#L47-L56](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/worker/worker-execution.js#L47-L56));
...
8. `postResult` sends one `result` message echoing the request id
   ([worker-execution.js#L69-L73](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/worker/worker-execution.js#L69-L73),
   [worker-execution.js#L177](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/worker/worker-execution.js#L177)).
9. Back in the manager, `_dispatchMessage`
   ([manager.js#L219](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/manager/manager.js#L219))
   finds the pending entry by id and clears its timeout
   ([manager.js#L220-L226](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/manager/manager.js#L220-L226)),
   lets `handleMessage` push the history entry (figures excluded, capped at 50
   entries,
   [manager.js#L367-L380](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/manager/manager.js#L367-L380)
   and
   [manager.js#L37](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/manager/manager.js#L37)),
   then resolves the promise with the full result
   ([manager.js#L250-L262](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/manager/manager.js#L250-L262)).
...
([worker-execution.js#L48](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/worker/worker-execution.js#L48));
...
2. Before or during the run, the host queues answers with `queueInput`
   ([manager-input.js#L70](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/manager/manager-input.js#L70))
   or registers a callback with `setInputCallback`
   ([manager-input.js#L83](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/manager/manager-input.js#L83)).
...
5. `requestInput`
   ([worker-input.js#L26-L37](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/worker/worker-input.js#L26-L37))
...
6. On the manager side, `handleInputMessage`
   ([manager-input.js#L118-L140](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/manager/manager-input.js#L118-L140))
   records the prompt, then either dequeues a queued answer and calls
   `provideInput` immediately
   ([manager-input.js#L125-L127](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/manager/manager-input.js#L125-L127)),
   or invokes the registered callback with the prompt
   ([manager-input.js#L129-L132](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/manager/manager-input.js#L129-L132)).
7. `provideInput`
   ([manager-input.js#L44-L59](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/manager/manager-input.js#L44-L59))
   posts `{type: "input_response", input}` to the worker.
8. `handleInputResponse`
   ([worker-input.js#L96-L113](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/worker/worker-input.js#L96-L113))
   ...
   ([manager.js#L353](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/manager/manager.js#L353),
   [manager-input.js#L148](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/manager/manager-input.js#L148)).
...
([code_transformation.py#L86](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/python/code_transformation.py#L86))
parses the code and lets `_AwaitInputTransformer`
([code_transformation.py#L15](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/python/code_transformation.py#L15))
wrap every call to the builtin `input` in `ast.Await`
([code_transformation.py#L54-L60](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/python/code_transformation.py#L54-L60)).
Names like `my_input()` or `obj.input()` are untouched, and calls inside
sync `def`, `lambda` or class bodies are left alone
([code_transformation.py#L25-L52](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/python/code_transformation.py#L25-L52)),
...
1. At init time, `setup_matplotlib`
   ...
   ([pyodide_utilities.py#L14](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/python/pyodide_utilities.py#L14))
   and made `plt.show()` a no-op
   ([pyodide_utilities.py#L23-L26](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/python/pyodide_utilities.py#L23-L26)),
   so nothing tries to open a window inside the worker.
2. `reset_captures()` closes figures left over from a previous run
   ([capture_system.py#L61-L69](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/python/capture_system.py#L61-L69)).
...
4. After the run, `captureOutputs` calls `get_figures()`
   ([worker-execution.js#L127](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/worker/worker-execution.js#L127),
   [capture_system.py#L112](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/python/capture_system.py#L112)):
   each open figure is saved to a `BytesIO` as PNG, base64-encoded and closed
   ([capture_system.py#L128-L134](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/python/capture_system.py#L128-L134)).
...
6. The resolved result keeps the figures, but the `executionHistory` entry
   ...
   ([manager.js#L364-L375](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/manager/manager.js#L364-L375)).
...
([code_transformation.py#L1-L11](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/python/code_transformation.py#L1-L11)).
...
([worker-execution.js#L35](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/worker/worker-execution.js#L35))
and runs the code with that dict as its globals
([worker-execution.js#L37](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/worker/worker-execution.js#L37)),
destroying the proxy afterwards
([worker-execution.js#L39](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/worker/worker-execution.js#L39)).
...
([manager.js#L416-L421](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/manager/manager.js#L416-L421)).
...
([manager.js#L219-L226](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/manager/manager.js#L219-L226)),
but the entry is still logged and pushed to `executionHistory`
([manager.js#L352-L381](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/manager/manager.js#L352-L381)).
...
([manager.js#L181-L192](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/manager/manager.js#L181-L192))
synthesize an error message without id. `_dispatchMessage` treats it as fatal:
`_readyReject(error)` and `_failAllPending(error)`
([manager.js#L240-L246](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/manager/manager.js#L240-L246),
[manager.js#L312-L318](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/manager/manager.js#L312-L318)),
so every in-flight `executeAsync` and `fs` promise rejects with the cause
instead of hanging. `destroy()`
([manager.js#L456-L477](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/manager/manager.js#L456-L477))
...
1. `manager.fs(operation, params, timeoutMs = 10000)`
   ([manager.js#L392](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/manager/manager.js#L392))
   delegates to `PyodideManagerFS.fs`
   ([manager-fs.js#L32](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/manager/manager-fs.js#L32)),
   which validates and forwards to `_sendFSCommand`
   ([manager-fs.js#L136-L146](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/manager/manager-fs.js#L136-L146)).
2. The request goes through the same `_postRequest` machinery as executions,
   ...
   ([manager-fs.js#L141-L145](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/manager/manager-fs.js#L141-L145)).
3. In the worker, `handleFSOperation`
   ([worker-fs.js#L17](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/worker/worker-fs.js#L17))
   runs `executeFS`
   ([worker-fs.js#L40-L63](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/worker/worker-fs.js#L40-L63)):
...
4. The worker answers `{type: "fs_result", id, result}`
   ([worker-fs.js#L25](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/worker/worker-fs.js#L25))
   or `{type: "fs_error", id, error}`
   ([worker-fs.js#L96](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/worker/worker-fs.js#L96)).
5. The manager resolves or rejects the pending promise
   ([manager.js#L263-L266](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/manager/manager.js#L263-L266)),
   and `fs()` unwraps the payload per operation: `readFile` returns the
   content, `exists` the boolean, `listdir` the file list
   ([manager-fs.js#L38-L50](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/manager/manager-fs.js#L38-L50)).
...
1. `createManager("brython", ...)` constructs a `BrythonManager`
   ([nagini.js#L55-L58](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/nagini.js#L55-L58),
   [manager.js#L12](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/brython/manager/manager.js#L12)).
   The constructor starts `loadBrython(brythonOptions)`
   ([manager.js#L29-L36](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/brython/manager/manager.js#L29-L36)),
   which injects `brython.js` then `brython_stdlib.js` as script tags and
   calls `window.brython({debug: 0})`
   ([loader.js#L14-L35](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/brython/manager/loader.js#L14-L35)).
   Default library paths are `/src/brython/lib/...`, overridable with
   `brythonJsPath` and `brythonStdlibPath`
   ([loader.js#L5-L8](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/brython/manager/loader.js#L5-L8)).
2. `executeAsync(filename, code, namespace, timeoutMs)`
   ([manager.js#L40](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/brython/manager/manager.js#L40))
   awaits readiness, validates, then delegates to the executor's
   `executeAsync`
   ([executor.js#L11](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/brython/manager/executor.js#L11)).
...
3. The executor builds a unique suffix for a script element id and a
   ...
   ([executor.js#L15-L17](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/brython/manager/executor.js#L15-L17)),
   and arms the timeout
   ([executor.js#L26-L29](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/brython/manager/executor.js#L26-L29)).
4. The user code is embedded as a JSON string inside a wrapper that captures
   ...
   ([executor.js#L41-L88](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/brython/manager/executor.js#L41-L88)).
5. The wrapper is appended to the page as a `<script type="text/python3">`
   ...
   ([executor.js#L90-L97](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/brython/manager/executor.js#L90-L97)).
6. Whether the code succeeds or raises, the wrapper calls the window callback
   with `{stdout, stderr, missive, error}`
   ([executor.js#L82-L87](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/brython/manager/executor.js#L82-L87)).
   ...
   ([executor.js#L31-L35](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/brython/manager/executor.js#L31-L35)).
7. `BrythonManager.executeAsync` maps the payload to the shared
   ...
   ([manager.js#L49-L61](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/brython/manager/manager.js#L49-L61)).
8. On timeout, `cleanup()` removes the script element and the callback, and
   the promise rejects
   ([executor.js#L19-L29](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/brython/manager/executor.js#L19-L29)).
   `input()`, packages and `fs()` are not supported on this backend
   ([manager.js#L69-L77](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/brython/manager/manager.js#L69-L77)).
...
`missive(data)`
([capture_system.py#L146-L166](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/python/capture_system.py#L146-L166))
guards against a second call
([capture_system.py#L152-L157](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/python/capture_system.py#L152-L157))
and stores the dict. After the run, `get_missive()` serializes it with
`json.dumps`
([capture_system.py#L92-L109](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/python/capture_system.py#L92-L109))
and the worker keeps it as a string on purpose
([worker-execution.js#L118-L123](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/pyodide/worker/worker-execution.js#L118-L123)).
...
([executor.js#L65-L69](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/brython/manager/executor.js#L65-L69))
and passes the value through the window callback; the manager forwards it
as-is
([manager.js#L54](https://github.com/pointcarre-app/nagini/blob/v0.0.50/src/brython/manager/manager.js#L54)).
