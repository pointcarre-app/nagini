...
1. `Nagini.createManager("pyodide", packages, micropipPackages, filesToLoad, workerPath, options)`
   ([nagini.js#L28](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/nagini.js#L28))
   checks the backend name with `validateBackend`
   ([validation.js#L208](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/utils/validation.js#L208)),
   requires a `worker-dist.js` path
   ([nagini.js#L34-L45](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/nagini.js#L34-L45)),
   dynamically imports the backend
   ([nagini.js#L47](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/nagini.js#L47))
   and constructs the manager
   ([nagini.js#L52](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/nagini.js#L52)).
2. The `PyodideManager` constructor
   ([manager.js#L51](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/manager/manager.js#L51))
   validates every argument
   ([manager.js#L55-L63](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/manager/manager.js#L55-L63)),
   creates the `readyPromise`
   ([manager.js#L107-L116](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/manager/manager.js#L107-L116))
   and calls `initWorker`
   ([manager.js#L119](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/manager/manager.js#L119)).
3. `initWorker`
   ([manager.js#L149](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/manager/manager.js#L149))
   fetches the bundle and wraps it in a blob URL with `createBlobWorkerUrl`
   ([createBlobWorker.js#L15](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/utils/createBlobWorker.js#L15)),
   creates the `Worker`
   ([manager.js#L155](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/manager/manager.js#L155)),
   installs `_dispatchMessage` as the permanent `onmessage` handler
   ([manager.js#L159](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/manager/manager.js#L159))
   and posts the `init` message
   ([manager.js#L177-L183](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/manager/manager.js#L177-L183)).
4. In the worker, `self.onmessage`
   ([worker.js#L48](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/worker/worker.js#L48))
   routes through `handleMessage`
   ([worker-handlers.js#L85](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/worker/worker-handlers.js#L85))
   to `handleInit`
   ([worker-handlers.js#L117](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/worker/worker-handlers.js#L117)):
   `importScripts` and `loadPyodide`
   ([worker-handlers.js#L132-L133](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/worker/worker-handlers.js#L132-L133))
   pull the runtime from the CDN pinned in
   ([worker-config.js#L17](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/worker/worker-config.js#L17))
...
6. `setupInputHandling`
   ([worker-input.js#L16](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/worker/worker-input.js#L16))
   ...
   code runs in
   ([worker-input.js#L39-L50](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/worker/worker-input.js#L39-L50)).
7. `filesToLoad` entries are downloaded into the virtual filesystem by
   `PyodideFileLoader.loadFiles`
   ([worker-handlers.js#L163-L171](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/worker/worker-handlers.js#L163-L171),
   [file-loader.js#L58](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/file-loader/file-loader.js#L58)),
   with three retries and exponential backoff.
8. Packages install through `loadPackages`
   ([worker-handlers.js#L174](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/worker/worker-handlers.js#L174),
   [worker-fs.js#L73](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/worker/worker-fs.js#L73)),
   micropip packages through `micropip.install`
   ([worker-handlers.js#L177-L193](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/worker/worker-handlers.js#L177-L193));
   both skip what this worker already loaded. Then `setup_matplotlib()`
   ([worker-handlers.js#L197](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/worker/worker-handlers.js#L197),
   [pyodide_utilities.py#L7](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/python/pyodide_utilities.py#L7))
   switches matplotlib to the `agg` backend if the package is present.
9. The worker posts `{type: "ready"}`
   ([worker-handlers.js#L202-L203](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/worker/worker-handlers.js#L202-L203)).
   The manager flips `isReady`
   ([manager.js#L311-L313](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/manager/manager.js#L311-L313))
   and resolves the `readyPromise`
   ([manager.js#L217-L219](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/manager/manager.js#L217-L219)).
10. `Nagini.waitForReady`
    ([nagini.js#L74](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/nagini.js#L74))
    races the `readyPromise` against a timeout
    ([nagini.js#L78-L86](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/nagini.js#L78-L86));
    managers without a `readyPromise` fall back to polling `isReady`
    ([nagini.js#L93-L99](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/nagini.js#L93-L99)).

Failure path: a bad worker path, a CDN failure or a crash during init produces
an error message without id
([worker-handlers.js#L205-L209](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/worker/worker-handlers.js#L205-L209)).
The manager then rejects the `readyPromise` with the original cause and fails
every pending request
([manager.js#L221-L227](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/manager/manager.js#L221-L227)),
so `waitForReady` surfaces the real error instead of a generic timeout.

Integration snippet:

```javascript
import { Nagini } from "https://esm.sh/gh/pointcarre-app/nagini@v0.0.44/src/nagini.js";
...
1. `manager.executeAsync(filename, code, namespace?, timeoutMs = 30000)`
   ([manager.js#L397](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/manager/manager.js#L397))
   chains the run on `executionChain`
   ([manager.js#L417-L418](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/manager/manager.js#L417-L418)),
   so two calls on the same manager never interleave.
2. When its turn comes, `run()` validates the parameters
   ([manager.js#L403](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/manager/manager.js#L403),
   [validation.js#L170](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/utils/validation.js#L170))
   and throws if the manager is not ready
   ([manager.js#L404-L406](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/manager/manager.js#L404-L406)).
3. `_postRequest`
   ([manager.js#L266](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/manager/manager.js#L266))
   allocates a correlation id
   ([manager.js#L268](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/manager/manager.js#L268)),
   stores `{resolve, reject, timeoutId}` in `_pendingRequests`
   ([manager.js#L275](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/manager/manager.js#L275)),
   arms the timeout
   ([manager.js#L269-L273](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/manager/manager.js#L269-L273))
   and posts `{type: "execute", filename, code, id}`
   ([manager.js#L278](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/manager/manager.js#L278)).
   `namespace` is added to the message only when provided
   ([manager.js#L407-L410](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/manager/manager.js#L407-L410)).
4. In the worker, `handleExecute`
   ([worker-execution.js#L18](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/worker/worker-execution.js#L18))
   first calls `transformCodeForExecution`
   ([worker-execution.js#L77](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/worker/worker-execution.js#L77)):
   a regex
   ([worker-execution.js#L81](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/worker/worker-execution.js#L81))
   looks for a genuine `input(` call. Without one, the code passes through
   unchanged (the `input()` rewrite is the next flow).
5. `reset_captures()`
   ([worker-execution.js#L29](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/worker/worker-execution.js#L29),
   [capture_system.py#L49](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/python/capture_system.py#L49))
   ...
   ([capture_system.py#L83-L84](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/python/capture_system.py#L83-L84)).
6. The code always runs through `runPythonAsync`
   ([worker-execution.js#L42](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/worker/worker-execution.js#L42)):
   it handles synchronous code identically and enables top-level `await`.
7. `captureOutputs`
   ([worker-execution.js#L101](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/worker/worker-execution.js#L101))
   pulls `get_stdout()` and `get_stderr()`
   ([capture_system.py#L87-L94](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/python/capture_system.py#L87-L94)),
   `get_missive()`
   ([capture_system.py#L103](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/python/capture_system.py#L103)),
   ...
   ([worker-execution.js#L47-L50](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/worker/worker-execution.js#L47-L50));
...
8. `postResult` sends one `result` message echoing the request id
   ([worker-execution.js#L64-L68](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/worker/worker-execution.js#L64-L68),
   [worker-execution.js#L149](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/worker/worker-execution.js#L149)).
9. Back in the manager, `_dispatchMessage`
   ([manager.js#L200](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/manager/manager.js#L200))
   finds the pending entry by id and clears its timeout
   ([manager.js#L201-L207](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/manager/manager.js#L201-L207)),
   lets `handleMessage` push the history entry (figures excluded, capped at 50
   entries,
   [manager.js#L348-L361](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/manager/manager.js#L348-L361)
   and
   [manager.js#L37](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/manager/manager.js#L37)),
   then resolves the promise with the full result
   ([manager.js#L231-L244](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/manager/manager.js#L231-L244)).
...
([worker-execution.js#L48](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/worker/worker-execution.js#L48));
...
1. Before or during the run, the host queues answers with `queueInput`
   ([manager-input.js#L65](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/manager/manager-input.js#L65))
   or registers a callback with `setInputCallback`
   ([manager-input.js#L78](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/manager/manager-input.js#L78)).
2. The execute message reaches the worker as usual. This time the regex gate
   ...
   ([worker-execution.js#L85](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/worker/worker-execution.js#L85)).
3. `transform_code_for_execution`
   ([code_transformation.py#L86](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/python/code_transformation.py#L86))
   parses the code and lets `_AwaitInputTransformer`
   ([code_transformation.py#L15](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/python/code_transformation.py#L15))
   wrap every call to the builtin `input` in `ast.Await`
   ([code_transformation.py#L54-L60](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/python/code_transformation.py#L54-L60)).
   Names like `my_input()` or `obj.input()` are untouched, and calls inside
   sync `def`, `lambda` or class bodies are left alone
   ([code_transformation.py#L25-L52](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/python/code_transformation.py#L25-L52)),
...
4. The rewritten code runs through `runPythonAsync`. Each `await input(...)`
   ...
   `requestInput(prompt)`.
5. `requestInput`
   ([worker-input.js#L18-L29](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/worker/worker-input.js#L18-L29))
...
6. On the manager side, `handleInputMessage`
   ([manager-input.js#L113-L135](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/manager/manager-input.js#L113-L135))
   records the prompt, then either dequeues a queued answer and calls
   `provideInput` immediately
   ([manager-input.js#L120-L122](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/manager/manager-input.js#L120-L122)),
   or invokes the registered callback with the prompt
   ([manager-input.js#L124-L127](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/manager/manager-input.js#L124-L127)).
7. `provideInput`
   ([manager-input.js#L41-L56](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/manager/manager-input.js#L41-L56))
   posts `{type: "input_response", input}` to the worker.
8. `handleInputResponse`
   ([worker-input.js#L64-L81](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/worker/worker-input.js#L64-L81))
   ...
   ([manager.js#L333](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/manager/manager.js#L333),
   [manager-input.js#L143](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/manager/manager-input.js#L143)).
...
1. At init time, `setup_matplotlib`
   ...
   ([pyodide_utilities.py#L14](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/python/pyodide_utilities.py#L14))
   and made `plt.show()` a no-op
   ([pyodide_utilities.py#L23-L26](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/python/pyodide_utilities.py#L23-L26)),
   so nothing tries to open a window inside the worker.
2. `reset_captures()` closes figures left over from a previous run
   ([capture_system.py#L61-L69](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/python/capture_system.py#L61-L69)).
...
4. After the run, `captureOutputs` calls `get_figures()`
   ([worker-execution.js#L117](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/worker/worker-execution.js#L117),
   [capture_system.py#L123](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/python/capture_system.py#L123)):
   each open figure is saved to a `BytesIO` as PNG, base64-encoded and closed
   ([capture_system.py#L139-L145](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/python/capture_system.py#L139-L145)).
...
6. The resolved result keeps the figures, but the `executionHistory` entry
   ...
   ([manager.js#L345-L356](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/manager/manager.js#L345-L356)).
...
([code_transformation.py#L1-L11](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/python/code_transformation.py#L1-L11)).
...
([worker-execution.js#L35](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/worker/worker-execution.js#L35))
and runs the code with that dict as its globals
([worker-execution.js#L37](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/worker/worker-execution.js#L37)),
destroying the proxy afterwards
([worker-execution.js#L39](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/worker/worker-execution.js#L39)).
...
([manager.js#L397-L402](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/manager/manager.js#L397-L402)).
...
([manager.js#L200-L207](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/manager/manager.js#L200-L207)),
but the entry is still logged and pushed to `executionHistory`
([manager.js#L332-L362](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/manager/manager.js#L332-L362)).
...
([manager.js#L163-L174](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/manager/manager.js#L163-L174))
synthesize an error message without id. `_dispatchMessage` treats it as fatal:
`_readyReject(error)` and `_failAllPending(error)`
([manager.js#L221-L227](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/manager/manager.js#L221-L227),
[manager.js#L294-L300](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/manager/manager.js#L294-L300)),
so every in-flight `executeAsync` and `fs` promise rejects with the cause
instead of hanging. `destroy()`
([manager.js#L437-L458](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/manager/manager.js#L437-L458))
...
1. `manager.fs(operation, params, timeoutMs = 10000)`
   ([manager.js#L373](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/manager/manager.js#L373))
   delegates to `PyodideManagerFS.fs`
   ([manager-fs.js#L32](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/manager/manager-fs.js#L32)),
   which validates and forwards to `_sendFSCommand`
   ([manager-fs.js#L136-L146](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/manager/manager-fs.js#L136-L146)).
2. The request goes through the same `_postRequest` machinery as executions,
   ...
   ([manager-fs.js#L141-L145](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/manager/manager-fs.js#L141-L145)).
3. In the worker, `handleFSOperation`
   ([worker-fs.js#L17](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/worker/worker-fs.js#L17))
   runs `executeFS`
   ([worker-fs.js#L40-L63](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/worker/worker-fs.js#L40-L63)):
...
4. The worker answers `{type: "fs_result", id, result}`
   ([worker-fs.js#L25](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/worker/worker-fs.js#L25))
   or `{type: "fs_error", id, error}`
   ([worker-fs.js#L96](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/worker/worker-fs.js#L96)).
5. The manager resolves or rejects the pending promise
   ([manager.js#L245-L248](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/manager/manager.js#L245-L248)),
   and `fs()` unwraps the payload per operation: `readFile` returns the
   content, `exists` the boolean, `listdir` the file list
   ([manager-fs.js#L38-L50](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/manager/manager-fs.js#L38-L50)).
...
1. `createManager("brython", ...)` constructs a `BrythonManager`
   ([nagini.js#L53-L56](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/nagini.js#L53-L56),
   [manager.js#L12](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/brython/manager/manager.js#L12)).
   The constructor starts `loadBrython(brythonOptions)`
   ([manager.js#L29-L36](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/brython/manager/manager.js#L29-L36)),
   which injects `brython.js` then `brython_stdlib.js` as script tags and
   calls `window.brython({debug: 0})`
   ([loader.js#L14-L35](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/brython/manager/loader.js#L14-L35)).
   Default library paths are `/src/brython/lib/...`, overridable with
   `brythonJsPath` and `brythonStdlibPath`
   ([loader.js#L5-L8](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/brython/manager/loader.js#L5-L8)).
2. `executeAsync(filename, code, namespace, timeoutMs)`
   ([manager.js#L40](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/brython/manager/manager.js#L40))
   awaits readiness, validates, then delegates to the executor's
   `executeAsync`
   ([executor.js#L11](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/brython/manager/executor.js#L11)).
...
3. The executor builds a unique suffix for a script element id and a
   ...
   ([executor.js#L15-L17](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/brython/manager/executor.js#L15-L17)),
   and arms the timeout
   ([executor.js#L26-L29](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/brython/manager/executor.js#L26-L29)).
4. The user code is embedded as a JSON string inside a wrapper that captures
   ...
   ([executor.js#L41-L88](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/brython/manager/executor.js#L41-L88)).
5. The wrapper is appended to the page as a `<script type="text/python3">`
   ...
   ([executor.js#L90-L97](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/brython/manager/executor.js#L90-L97)).
6. Whether the code succeeds or raises, the wrapper calls the window callback
   with `{stdout, stderr, missive, error}`
   ([executor.js#L82-L87](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/brython/manager/executor.js#L82-L87)).
   ...
   ([executor.js#L31-L35](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/brython/manager/executor.js#L31-L35)).
7. `BrythonManager.executeAsync` maps the payload to the shared
   ...
   ([manager.js#L49-L61](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/brython/manager/manager.js#L49-L61)).
8. On timeout, `cleanup()` removes the script element and the callback, and
   the promise rejects
   ([executor.js#L19-L29](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/brython/manager/executor.js#L19-L29)).
   `input()`, packages and `fs()` are not supported on this backend
   ([manager.js#L69-L77](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/brython/manager/manager.js#L69-L77)).
...
`missive(data)`
([capture_system.py#L207-L224](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/python/capture_system.py#L207-L224))
guards against a second call
([capture_system.py#L213-L218](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/python/capture_system.py#L213-L218))
and stores the dict. After the run, `get_missive()` serializes it with
`json.dumps`
([capture_system.py#L103-L120](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/python/capture_system.py#L103-L120))
and the worker keeps it as a string on purpose
([worker-execution.js#L108-L113](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/pyodide/worker/worker-execution.js#L108-L113)).
...
([executor.js#L65-L69](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/brython/manager/executor.js#L65-L69))
and passes the value through the window callback; the manager forwards it
as-is
([manager.js#L54](https://github.com/pointcarre-app/nagini/blob/v0.0.44/src/brython/manager/manager.js#L54)).
